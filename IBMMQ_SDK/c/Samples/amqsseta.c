/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsseta.c */
 /********************************************************************/
 /*                                                                  */
 /* Program name: AMQSSETA                                           */
 /*                                                                  */
 ...
 /********************************************************************/
 /*                                                                  */
 /*   AMQSSETA has 1 parameter - a string (MQTMC2) based on the      */
     ...
     if (CompCode == MQCC_OK)
     {
       ...
       else
       {
         ...
         if (CompCode == MQCC_OK)
         {
           ...
           messlen  = (MQLONG)strlen(buffer);             /* length of reply */
