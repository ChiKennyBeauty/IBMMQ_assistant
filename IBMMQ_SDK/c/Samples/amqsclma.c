/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsclma.c */
/***********************************************************************/
/*                                                                     */
...
static const char version[] = "@(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsclma.c (product)";
#else
static const char version[] = "@(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsclma.c (custom)";
#endif
...
MQUINT64 getCurrentMilliseconds(void);
...
int main( int argc, char *argv[] )
{
...
#if (MQAT_DEFAULT == MQAT_WINDOWS_NT)
  sprintf(pid, "%u", GetCurrentProcessId());
#else
  ...
  while (!StopMon)
  {
                  ...
                  switch(DefnLQ.CLWLUSEQ)
                  {
                    ...
                    case MQCLWL_USEQ_AS_Q_MGR:
                      ...
                      if(qMgrCLWLUSEQ == -1)
                      {
                        ...
                        {
                          sprintf(dbs,"Queue manager CLWLUSEQ=%d\n",
                                  qMgrCLWLUSEQ);
                          WriteToRpt(DEBUGMSGD, 1, 0, dbs);
                        }
    ...
    if (!StopMon && !errorReported && !firstTimeHere)
    {
      ...
      intElapsedTime = (long)((endtime - intStartTime) / 1000);
              ...
              MQLONG   CurDepth)
{
  ...
  MQBYTE *pUserMsg = NULL;  /* Pointer to buffer that receives the msg */
...
/*                                                                     */
/***********************************************************************/
MQUINT64 getCurrentMilliseconds()
{
#if (MQAT_DEFAULT == MQAT_WINDOWS_NT)
  ...
  return (counter.tv_sec * 1000 + (counter.tv_nsec / 1000000));
#else
