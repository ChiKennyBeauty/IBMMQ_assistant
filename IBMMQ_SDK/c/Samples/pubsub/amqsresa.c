/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/pubsub/amqsresa.c */
/*********************************************************************/
/*                                                                   */
            ...
            if( *pCompCode == MQCC_OK )
            {
              ...
              else
              {
                ...
                if( blankSpace != NULL )
                {
                  ...
                  /***************************************************/
                  (void)sscanf(pUserData,"%d %d", &(pNewMatch->Team1Score),
                  ...
                  , PMQLONG       pReason )
{
  ...
  else
  {
    ...
    /*****************************************************************/
    strncpy( md.ReplyToQ, SUBSCRIBER_QUEUE, MQ_Q_NAME_LENGTH);
                     ...
                     , PMQLONG  pReason )
{
  ...
  else
  {
    ...
    if( memcmp(pMd->Format, MQFMT_RF_HEADER, MQ_FORMAT_LENGTH) == 0 )
    {
      ...
      /***************************************************************/
      (void)sscanf(pNameValueString, "MQPSCompCode %d MQPSReason %d ",
                                                 pCompCode, pReason);
      if( *pCompCode != MQCC_OK )
      {
        /*************************************************************/
...
void TeleType( PMQCHAR pChar )
{
  ...
  while( *pChar != '\0' )
  {
    ...
    /*****************************************************************/
    else if( isdigit( (unsigned char)*pChar ) )
    {
