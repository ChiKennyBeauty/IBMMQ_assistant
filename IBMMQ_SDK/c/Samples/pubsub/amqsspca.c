static const char sccsid[] = "@(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/pubsub/amqsspca.c";
/******************************************************************************/
/*                                                                            */
...
int main(int argc, char *argv[])
{
  ...
  else
  {
    ...
    SubscriberQ[MQ_Q_NAME_LENGTH] = 0;
  }
...
{
  MQLONG     replyCode = MQCC_FAILED;   /* broker reply code        */
  MQMD       md = { MQMD_DEFAULT };     /* message descriptor       */
