/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsinqa.c */
 /********************************************************************/
 /*                                                                  */
 /* Program name: AMQSINQA                                           */
 /*                                                                  */
 ...
 /*                                                                  */
 /*                                                                  */
 /*   AMQSINQA is a sample C program that inquires selected          */
 ...
 /*                                                                  */
 /*   NOTE: One way to run AMQSINQA is to be running any             */
   ...
   while (CompCode == MQCC_OK)
   {
     ...
     {                          /* message received        */
       ...
       else
       {
         ...
         if (CompCode == MQCC_OK)
         {
           sprintf(reply, " has %d messages, used by %d jobs",
                                IAV[1],              IAV[2]);
           strcat(buffer, reply);
