/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsstma.c */
 /********************************************************************/
 /*                                                                  */
 ...
 int main(int argc, char **argv)
 {
   ...
   /* @@@@ Use the following line to define a message descriptor     */
   /*      variable that can be passed into the MQPUT call below.    */
