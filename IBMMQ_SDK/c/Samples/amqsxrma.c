/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsxrma.c */
 /********************************************************************/
 /*                                                                  */
 /* Program name: AMQSXRMA                                           */
 /*                                                                  */
 ...
 /********************************************************************/
 /*                                                                  */
 /*   AMQSXRMA has the usual parameters defined for channel exit     */
 /*       programs.                                                  */
 /*                                                                  */
 /********************************************************************/
 /*                                                                  */
 /*   If a function call within AMQSXRMA fails, a feedback code is   */
