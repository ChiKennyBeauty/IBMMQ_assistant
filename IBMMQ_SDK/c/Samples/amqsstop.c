/* @(#) MQMBID sn=p944-L251007.1.DE su=f84fdb91fb9772dfb286437c1f42e7849ffc8dc7 pn=samples/c/amqsstop.c */
/********************************************************************/
/*                                                                  */
...
int main(int argc, char **argv)
{
  ...
  MQCHAR   CmdQueue[]="SYSTEM.ADMIN.COMMAND.QUEUE";
                                   /* Resolved reply Q name         */
  MQCHAR   ResolvedReplyQ[MQ_Q_NAME_LENGTH + 1];
  ...
  ResolvedReplyQ[MQ_Q_NAME_LENGTH] = 0;
